...
```text
Manus 右手 -> 21x3 人手关键点 -> canonical 手坐标 -> dex-retargeting 官方 IK -> G20 右手 20维参数
```

## 1. 当前实现结论

截至 2026-04-28，当前 G20 版本已经满足这三点：
...
1. `RetargetingConfig.load_from_file(...).build()`
2. `retargeting.retarget(ref_value)`
